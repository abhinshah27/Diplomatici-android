...
package rs.highlande.app.diplomatici.features.chat
...
import rs.highlande.app.diplomatici.models.chat.ChatMessageType
...
import rs.highlande.app.diplomatici.utilities.helpers.ShareHelper
    ...
    override fun configureLayout(view: View) {
        ...
        btnSend.setOnClickListener {
            ...
            if (!participantId.isNullOrBlank() && chatRoom?.isValid() == true) {
                ...
                if (DiplomaticiApp.canVibrate) vibrateForChat(context)
...
//        setMessages()
    ...
    override fun setLayout() {
        ...
        // shows/hides string in toolbar depending on what type of user is logged into the app
        requestedFrom.visibility = if (!mUser.isUserNormal) View.VISIBLE else View.GONE
...
//            callServer(CallType.SET_READ, setIncomingRT = true)
    ...
    fun callServer(type: CallType, chatMessage: ChatMessage? = null, setIncomingRT: Boolean = false,
        ...
        HLRequestTracker.getInstance(activity?.application as? DiplomaticiApp).handleCallResult(this, activity as? HLActivity, result, true, false)
    }
