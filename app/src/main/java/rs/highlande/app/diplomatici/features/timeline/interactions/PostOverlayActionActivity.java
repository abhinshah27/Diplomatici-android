...
import rs.highlande.app.diplomatici.utilities.helpers.SearchHelper;
...
public class PostOverlayActionActivity extends HLActivity implements View.OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// INFO: 2019-10-09    no shares
		btnShares.setVisibility(/*mPost == null || !mPost.isPublic()*/true ? View.GONE : View.VISIBLE);
...
//				}).start();
	...
	private void setShareSectionAndOpen(boolean open) {
		if (open) {
			...
			// INFO: 2019-10-09    no shares
			btnShares.setVisibility(/*mPost.isPublic()*/false ? View.VISIBLE : View.GONE);
