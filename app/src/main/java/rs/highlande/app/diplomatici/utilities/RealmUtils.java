...
public class RealmUtils {
	 ...
	 * {@link DiplomaticiApp#realmConfig}.
	...
	public static Realm getCheckedRealm() {
		...
		DiplomaticiApp.openRealms.add(realm);
	...
	public static void closeRealm(Realm realm) {
		if (realm != null) {
			realm.close();
			DiplomaticiApp.openRealms.remove(realm);
		}
	}

	public static void closeAllRealms() {
		if (DiplomaticiApp.openRealms != null && !DiplomaticiApp.openRealms.isEmpty()) {
			for (Realm realm : DiplomaticiApp.openRealms) {
				try {
			...
			DiplomaticiApp.openRealms.clear();
		}
	}
