package rs.highlande.app.diplomatici.features.userDocumentation
...
import rs.highlande.app.diplomatici.utilities.media.DownloadReceiver
...
//    }
    ...
    private fun sendDocDownloadedHack() {
        ...
        if (!documentToDownload.isNullOrBlank()) {
            ...
            HLRequestTracker.getInstance(application as DiplomaticiApp).handleCallResult(this, this, result)
        }
    }
