...
package rs.highlande.app.diplomatici.utilities.media
...
import rs.highlande.app.diplomatici.connection.ProgressRequestBody
...
import rs.highlande.app.diplomatici.utilities.listeners.OnPermissionsDenied
...
class MediaUploadManager(context: Context,
    ...
    inner class UploadService(private val activity: HLActivity) {
         ...
         * @param userId   the [rs.highlande.app.models.HLUser._id] of the user uploading the picture.
