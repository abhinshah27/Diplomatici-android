...
import rs.highlande.app.diplomatici.utilities.baseAnimateAlpha
...
import rs.highlande.app.diplomatici.utilities.listeners.*
...
//            Constants.PERMISSIONS_REQUEST_READ_WRITE_AUDIO -> animateMediaPanel()
    ...
    override fun onStopRecording(mediaFileUri: String?, exceptionCaught: Boolean) {
        ...
        fragment.recordOverlay.post {
            // reset original view position (??)
            fragment.recordOverlay.translationX = 0f
        }
    }
