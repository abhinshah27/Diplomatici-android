...
package rs.highlande.app.diplomatici.features.voiceVideoCalls
...
import kotlinx.android.synthetic.main.bar_tool_home_profile_others.*
...
import rs.highlande.app.diplomatici.features.splash.SplashActivity
import rs.highlande.app.diplomatici.features.voiceVideoCalls.tmp.ACTION_MAIN
import rs.highlande.app.diplomatici.features.voiceVideoCalls.tmp.VoiceVideoCallType
import rs.highlande.app.diplomatici.features.voiceVideoCalls.tmp.VoiceVideoUsageType
...
//                    this.addAction(NotificationCompat.Action.Builder(0, "Mute", mutePending).build())
            ...
            NotificationType.MISSED_CALL -> {
                val appIntent = Intent(this, if (DiplomaticiApp.isForeground) HomeActivity::class.java else SplashActivity::class.java)
