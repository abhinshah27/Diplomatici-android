...
//		, InnerCircleFragment.OnLocationUpdateActionsListener
{
	...
	private boolean wasAppForeground = true;
...
//				break;
	...
	protected void manageIntent() {
		...
		wasAppForeground = extras != null && extras.getBoolean(Constants.KEY_NOTIFICATION_FOREGROUND, true);
...
//			FragmentsUtils.addFragmentNotNull(fragmentTransaction, fragment, target, requestCode);
	...
	public static void openNotificationsFragmentFromNotification(Context context, boolean foreground) {
		Bundle b = new Bundle();
		b.putBoolean(Constants.KEY_NOTIFICATION_FOREGROUND, foreground);
		FragmentsUtils.openFragment(context,b, Constants.FRAGMENT_NOTIFICATIONS, Constants.NO_RESULT, ProfileActivity.class);
	}
