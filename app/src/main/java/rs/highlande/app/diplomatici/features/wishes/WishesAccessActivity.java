...
import rs.highlande.app.diplomatici.features.legacyContact.LegacyContactSelectionActivity;
...
public class WishesAccessActivity extends HLActivity implements View.OnClickListener, OnServerMessageReceivedListener,
	...
	private void callForAvailability() {
		...
		HLRequestTracker.getInstance(((DiplomaticiApp) this.getApplication()))
