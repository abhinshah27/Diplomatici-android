...
import rs.highlande.app.diplomatici.utilities.listeners.TapAndHoldGestureListener;
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		if (getActivity() instanceof HLActivity) {
			...
			if (siriComposition == null) {
				DiplomaticiApp.initLottieAnimation(getActivity(), new LottieCompositioListener() {
					@Override
