...
import rs.highlande.app.diplomatici.features.viewers.VideoViewActivity
...
import rs.highlande.app.diplomatici.utilities.caches.AudioVideoCache
            ...
            when (messageItem?.getStatusEnum()) {
                ...
                ChatMessage.Status.DELIVERED -> {
                    context.getString(
                            ...
                            ", ${getFormattedDateForMessages(messageItem.deliveryDateObj)}"
                    )
                }
...
class ChatMessageVHMediaLocation(itemView: View, fragment: ChatMessagesFragment): ChatMessageVHMedia(itemView, fragment),
    ...
    override fun onClick(v: View?) {
        ...
        Utils.fireMapIntent(context, location.latitude, location.longitude, null)
    }
