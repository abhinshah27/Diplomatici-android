package rs.highlande.app.diplomatici.features.home
...
import kotlinx.android.synthetic.main.bar_tool_home_wv.*
import kotlinx.android.synthetic.main.bar_tool_home_wv.view.*
                ...
                try {
                    ...
                    if (user != null) {
                        if (user.isValid) {
                            ...
                            afterLogin = true
                            Utils.checkAndOpenLogin(mContext, user, HomeActivity.PAGER_ITEM_GLOBAL_SEARCH)
                        }
