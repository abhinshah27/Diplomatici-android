...
package rs.highlande.app.diplomatici.connection.realTime
...
import rs.highlande.app.diplomatici.base.BaseSingletonWithArgument
...
import rs.highlande.app.diplomatici.fcm.FCMMessagingService
import rs.highlande.app.diplomatici.features.chat.ChatMessagesFragment
import rs.highlande.app.diplomatici.features.chat.ChatRoomsFragment
import rs.highlande.app.diplomatici.features.chat.HandleChatCreationService
import rs.highlande.app.diplomatici.features.chat.RealTimeChatListener
...
import rs.highlande.app.diplomatici.models.*
import rs.highlande.app.diplomatici.models.chat.ChatMessage
import rs.highlande.app.diplomatici.models.chat.ChatRecipientStatus
import rs.highlande.app.diplomatici.models.chat.ChatRoom
import rs.highlande.app.diplomatici.utilities.*
import rs.highlande.app.diplomatici.utilities.helpers.WebLinkRecognizer
import rs.highlande.app.diplomatici.utilities.media.BaseSoundPoolManager
import java.util.*
            ...
            if (listenerChat != null) {
                when (listenerChat) {
                    is ChatRoomsFragment -> {
                        ...
                        if (DiplomaticiApp.canVibrate) vibrateForChat(mContext)
...
//        }
    ...
    private fun callSetDataRead() {
        ...
        if (mContext is HLActivity)
            HLRequestTracker.getInstance((mContext as HLActivity).application as DiplomaticiApp)
