...
public class Interest implements RealmModel, RealmModelListener, Serializable,
	...
	@SerializedName(value = "idInterest", alternate = {"_id", "interestID", "userID"})
	...
	private String type = ProfileTypeEnum.GENERAL.toString();
	...
	*/
	...
	public boolean isInterestNormal() {
		return ProfileTypeEnum.toEnum(type) == ProfileTypeEnum.GENERAL;
	}
	public boolean isInterestLocation() {
		return ProfileTypeEnum.toEnum(type) == ProfileTypeEnum.LOCATION;
	}
	public boolean isInterestEvent() {
		return ProfileTypeEnum.toEnum(type) == ProfileTypeEnum.EVENT;
	}
	public boolean isInterestSpeaker() {
		return ProfileTypeEnum.toEnum(type) == ProfileTypeEnum.SPEAKER;
	}

	public boolean wantsLocation() {
		return isInterestEvent() || isInterestLocation();
	}
