...
import rs.highlande.app.diplomatici.connection.HLSocketConnection;
 ...
 */
public class DiplomaticiApp extends MultiDexApplication implements OnApplicationContextNeeded {

	public static final String LOG_TAG = DiplomaticiApp.class.getCanonicalName();
	...
	public void onCreate() {
		...
		realmConfig = new RealmConfiguration.Builder()
				...
				.schemaVersion(0)
//				.migration(new DiplomaticiMigration())
				.build();
...
//			@Override
//			public void run() {
//				LottieCompositionFactory.Factory.fromAssetFileName(DiplomaticiApp.this, "siri.json",
...
//		    mChannel.enableVibration(true);
	...
	public void setSiriComposition(LottieComposition siriComposition) {
		DiplomaticiApp.siriComposition = siriComposition;
	}
